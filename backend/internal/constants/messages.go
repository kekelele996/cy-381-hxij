...
const (
	...
	MsgSettlementTransferred = "已标记为我已转账，等待收款方确认"
	MsgSettlementConfirmed   = "收款确认成功，双方净余额已更新"
	...
	MsgErrSettlementParty = "只有转账的付款方/收款方本人才能操作，不能代对方确认"
	MsgErrSettlementState = "转账当前状态不允许该操作（可能已被确认或作废）"
